...
values
  ('11111111-1111-4111-8111-111111111111', 'Faut-il rendre obligatoire la validation téléphonique pour les sondages en ligne ?', 'La vérification téléphonique peut renforcer la fiabilité d’un sondage en limitant les participations multiples. Elle introduit aussi une étape supplémentaire et soulève des attentes fortes en matière de confidentialité. La question consiste à arbitrer entre intégrité des résultats, simplicité d’accès et protection des données.', 'open', 'societe', true, 'Débat civique', now() + interval '4 days'),
  ('11111111-1111-4111-8111-111111111112', 'Faut-il rendre publics les grands arbitrages budgétaires avant leur vote ?', 'Rendre les arbitrages budgétaires visibles avant leur adoption permettrait au public de mieux comprendre les priorités et les compromis retenus. Cette transparence doit toutefois rester compatible avec la négociation, la lisibilité des documents et la capacité des institutions à faire évoluer leurs décisions.', 'open', 'politique', true, 'En hausse', now() + interval '3 days 8 hours'),
  ('11111111-1111-4111-8111-111111111113', 'Le télétravail doit-il devenir un droit négocié dans chaque entreprise ?', 'Le télétravail modifie l’organisation, les coûts et l’équilibre entre vie professionnelle et personnelle. En faire un droit négocié créerait un cadre commun, mais les contraintes diffèrent fortement selon les métiers et les entreprises. L’enjeu est de concilier souplesse, équité et continuité de l’activité.', 'open', 'economie', true, 'Travail', now() + interval '5 days'),
