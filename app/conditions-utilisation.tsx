...
export default function TermsPage() {
  return <LegalPage eyebrow="Cadre d’utilisation" title="Conditions d’utilisation" intro="Règles générales applicables à l’accès et à l’utilisation du service Stamio." sections={[
